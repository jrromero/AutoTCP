...
# Script used to train EvoFlow on the ahmadreza dataset

import os
import subprocess

base_path = os.path.dirname(os.path.abspath(__file__))
versions_path = os.path.join(base_path, 'dataset/datasets/data/versions/ahmadreza')
...
if __name__ == '__main__':
	...
	results_folder = 'out_ahmadreza_1seed_auc_reduce_25_25'
